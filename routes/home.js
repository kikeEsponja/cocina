        ...
        async function cargarRecetas() {
            ...
            const response = await fetch('https://leeresmipasion.com:1034/api/recipes');
            ...
            recipes.forEach(recipes => {
                    ...
                    recipeElement.addEventListener('click', () => {
                        ...
                        window.location.href = `./public/itemDetailen.html?id=${recipes.recipe.label}`;
                    });
        ...
        async function searchRecipes() {
            ...
            try {
                ...
                const response = await fetch(`https://leeresmipasion.com:1035/api/search?query=${encodeURIComponent(query)}`);
        ...
        function displayRecipes(recipes) {
            ...
            recipes.forEach(recipes => {
                ...
                recipeElement.addEventListener('click', () => {
                    localStorage.setItem('recipeDetails', JSON.stringify(recipes));
                    window.location.href = `../public/itemDetailen.html?id=${recipes.recipe.id}`;
                });
                recipesContainer.appendChild(recipeElement);
            });
        }